...
/**
 * Assignment: https://cw.fel.cvut.cz/wiki/courses/b4b36pdv/tutorials/hw_01 (in czech)
 */
...
int main() {
    ...
    ThreadPool<unsigned long long, decltype(worker)> pool(NWORKERS, worker);
