...
//    vector<vector<int8_t>> data(2, vector<int8_t>(50));
    //spravne reseni
...
//    generator.generateDistribution(lengths, 100, 100, 0);
...
/**
 * Assignment: https://cw.fel.cvut.cz/wiki/courses/b4b36pdv/tutorials/hw_02 (in czech)
 */
